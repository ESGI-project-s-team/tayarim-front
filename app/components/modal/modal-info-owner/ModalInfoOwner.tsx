...
export default function ModalInfoOwner({isOpen, onClose, user}: {
    isOpen: boolean;
    onClose: () => void;
    user: ProprietaireDTO;
}) {
                                    ...
                                    <div className="flex flex-col gap-9">
                                        <div className="rounded-sm border stroke-1 bg-white shadow">
                                            <div className="border-b border-[#dee4ee] py-4 flex justify-between px-7">
                                                <h3 className="font-medium text-black">{translation?.t('info_owner')}</h3>
                                                ...
                                                <div className="mt-8 space-y-6">
                                                    <div>
                                                        ...
                                                        <input type="text" id="commission" name="commission"
                                                               value={user.commission + ' %'} readOnly
