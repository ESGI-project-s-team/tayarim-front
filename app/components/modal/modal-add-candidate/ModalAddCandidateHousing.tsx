...
export default function ModalAddCandidateHousing({isOpen, onClose, owner}: {
    isOpen: boolean;
    onClose: () => void;
    owner: any;
}) {
                                        ...
                                        <div className="rounded-sm border stroke-1 bg-white shadow">
                                            ...
                                            <div className="p-7">
                                                ...
                                                <div className="flex justify-between mt-5">
                                                    ...
                                                    {currentStep < (formValues.isLouable ? 5 : 4) ? (
                                                        <button
                                                            type="button"
                                                            onClick={handleNext}
                                                ...
                                                <div className="mt-4">
                                                    <div className="text-sm font-medium text-gray-500">
                                                        {translation?.t('step')} {currentStep} {translation?.t('of')} {formValues.isLouable ? 5 : 4}
                                                    </div>
                                                    <div className="relative pt-1">
                                                        <div
                                                            className="overflow-hidden h-2 text-xs flex rounded bg-gray-200">
                                                            <div
                                                                style={{width: `${(currentStep / (formValues.isLouable ? 5 : 4)) * 100}%`}}
