...
import {deleteInvoiceInFun} from "@/app/components/modal/modal-delete-invoice/action";

export default function ModalDeleteInvoice({isOpen, onClose, id, getAllInvoice}: {
    isOpen: boolean;
    onClose: () => void;
    getAllInvoice: any;
    id: string;
    ...
    const handleDeleteOwner = async () => {
        setLoading(true)
        try {
            deleteInvoiceInFun(id).then((response) => {
                if (response.errors) {
